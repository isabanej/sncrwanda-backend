# Ensure Emino password by calling auth-service internal endpoint directly on :9092
$base = 'http://localhost:9092/auth/_internal'
Write-Host "Checking auth-service directly on :9092 ($base/login-simple)"
try {
